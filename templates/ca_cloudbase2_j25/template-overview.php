...
<br />
<h1>CloudBase 2.0 Template</h1>
				<h2>About Template</h2>
				<p>CloudBase 2.0 is an advanced template created by <a href="http://www.cloudaccess.net">CloudAccess.net</a>. It's based on <a href="http://www.gantry-framework.org">Gantry Framework</a> developed by <a href="http://www.rockettheme.com">RocketTheme</a>.</p>
				<p>Additional features we created on top of those Gantry offers:</p>
				<ul>
					<li>11 template presets (color variations)</li>
					<li>10 background patterns</li>
					<li>One of the most advanced system of picking colors for each template element</li>
					<li>improved "Scroll to top" feature</li>
					<li>Equal height for modules</li>
					<li>60 module positions</li>
				</ul>
				<h2>Module Positions</h2>
				<img src="<?php echo $gantry->templateUrl . '/images/modulePositions.jpg';?>" alt="Module positions" style="margin-bottom: 15px;" />


<h2>CloudBase 2.0 Presets</h2>
