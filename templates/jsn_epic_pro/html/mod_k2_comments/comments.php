<?php
/**
 * @version		$Id: comments.php 10214 2011-12-13 11:11:52Z hieudm $
 * @package		K2
...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<strong><?php echo JText::_('K2_PUBLISHED_IN') ; ?>:</strong> <span class="lcItemTitle"><a href="<?php echo $comment->itemLink; ?>"><?php echo $comment->title; ?></a></span>
			<?php endif; ?>
