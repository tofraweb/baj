<?php
/**
 * @version		$Id: item.php 12781 2012-05-18 03:38:35Z ngocpm $
 * @package		K2
...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
	...
	<div class="itemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="jsn-article-info">
				...
				<!-- Item date modified -->
				<p class="itemDateModified createdate"><?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?></p>
				<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
	...
	<!-- Item Hits --> 
	<span class="itemHits"> <?php echo JText::_('K2_READ'); ?> <strong><?php echo $this->item->hits; ?></strong> <?php echo JText::_('K2_TIMES'); ?> </span>
	<?php endif; ?>
