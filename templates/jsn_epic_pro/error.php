 ...
 */
	...
	$template_color = $params->get("templateColor", "blue");
?>
			...
			<div id="jsn-page_inner">
				...
				<div id="jsn-body" class="clearafter">
					<div id="jsn-error-heading">
						<h1><?php echo $this->error->getCode(); ?> <span class="heading-medium"><?php echo JText::_('JERROR_ERROR'); ?></span><span class="heading-small"><?php echo $this->error->getMessage(); ?></span></h1>
					</div>
