...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>"> 
			...
			<p class="createdate"><span class="moduleItemDateCreated"><?php echo JText::_('K2_WRITTEN_ON') ; ?> <?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC2')); ?></span></p>
			<?php endif; ?>
			...
			<p class="moduleItemCategory"><strong><?php echo JText::_('K2_PUBLISHED_IN') ; ?>:</strong> <a href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></p>
			<?php endif; ?>
			...
			<p class="moduleAttachments"> <strong><?php echo JText::_('K2_DOWNLOAD_ATTACHMENTS'); ?></strong><br />
