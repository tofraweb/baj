<?php
/**
 * @version		$Id: category_item.php 10266 2011-12-15 04:17:02Z hieudm $
 * @package		K2
	...
	<div class="catItemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="jsn-article-info">
				...
				<!-- Item Author -->
				<p class="author"><span class="catItemAuthor"> <?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> </span></p>
				<?php endif; ?>
				<?php if($this->item->params->get('catItemDateCreated')): ?>
				<!-- Date created -->
				<p class="createdate"><span class="catItemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </span></p>
				<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
