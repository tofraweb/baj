 ...
 * @version   $Id: jsn_manualupdater.php 13648 2012-06-29 04:35:27Z ngocpm $
 */
				...
				<?php } else { ?>
				 <script type="text/javascript">
						...
						window.addEvent('domready', function() {
							...
							objJSNUpdater.backupModifiedFile('<?php echo strtolower($template_manifest['full_name']);?>', '<?php echo basename($result_update['dir']);?>', '<?php echo JURI::root();?>', <?php echo $template_style_id; ?>, false);
						});
				</script>
							...
							<div id="jsn-update-succesfully-wrapper" class="jsn-updater-display-none">
								...
								<div class="text-alert-1 jsn-updater-display-none" id="text-alert-attention">
									...
									<ul>
										...
										<li><a href="http://www.joomlashine.com/docs/joomla-templates/how-to-update-template.html" target="_blank" class="link-action"><?php echo JText::_('JSN_UPDATE_CHANGES_INSTRUCTION'); ?></a></li>
									</ul>
								</div>
							</div>
							<div class="jsn-button">
