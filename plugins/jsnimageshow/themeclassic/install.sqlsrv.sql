...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[#__imageshow_theme_classic]') AND type in (N'U'))
BEGIN
CREATE TABLE [#__imageshow_theme_classic](
 ...
 CONSTRAINT [PK_#__imageshow_theme_classic_theme_id] PRIMARY KEY CLUSTERED 
(
	[theme_id] ASC
