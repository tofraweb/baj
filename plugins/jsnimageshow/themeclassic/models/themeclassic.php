 ...
 * @version $Id: themeclassic.php 10583 2011-12-29 10:23:37Z trungnq $
...
class ThemeClassic
{
	...
	{
		$showcaseThemeTable = $this->getTable($themeID);
	...
	{
		$db    = JFactory::getDbo();
		$query = 'SELECT * FROM #__imageshow_theme_classic WHERE theme_id = '.(int) $id;
		$db->setQuery($query);
		$data = $db->loadObject();
		return $data;
	}
