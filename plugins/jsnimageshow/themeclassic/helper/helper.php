 ...
 * @version $Id: helper.php 12254 2012-04-20 03:14:09Z giangnd $
...
defined('_JEXEC') or die( 'Restricted access' );
			...
			//Image Presentation Begin
				...
				$lists['imgPanelImgZoomingTypeExpand'] = JHTML::_('select.genericList', $imgPanelImgZoomingTypeExpand, 'imgpanel_img_zooming_type_expand', 'class="inputbox"', 'value', 'text', ($items->imgpanel_img_zooming_type_expand!='')?$items->imgpanel_img_zooming_type_expand:'center' );
				...
				$lists['imgPanelImgMotionTypeExpand'] = JHTML::_('select.genericList', $imgPanelImgMotionTypeExpand, 'imgpanel_img_motion_type_expand', 'class="inputbox '.$classImagePanel.'" onchange="JSNISClassicTheme.showcaseChangeImageMotionType(this); " ', 'value', 'text', ($items->imgpanel_img_motion_type_expand!='')?$items->imgpanel_img_motion_type_expand:'center-random' );
				...
				$lists['imgPanelImgShowImageShadowFit'] = JSNISHTMLSelect::booleanlist('imgpanel_img_show_image_shadow_fit','class="inputbox '.$classImagePanel.'"', $items->imgpanel_img_show_image_shadow_fit);
