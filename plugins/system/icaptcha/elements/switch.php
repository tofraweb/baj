...
class JFormFieldSwitch extends JFormField
{
	...
	protected function getInput()
	{
		...
		if (!defined ('_PARAM_HELPER')) {
			...
			$document->addScript(JURI::root(true).'/plugins/system/icaptcha/elements/jscolor/jscolor.js');
			$document->addScript(JURI::root(true).'/plugins/system/icaptcha/elements/paramhelper.js');
			$document->addStyleSheet(JURI::root(true).'/plugins/system/icaptcha/elements/paramhelper.css');
		}
