...
# @version $Id: jsnjoomlaxtc.php 12506 2012-05-09 03:55:24Z hiennh $
-------------------------------------------------------------------------*/
					...
					if ( count($modules) ){
						foreach ( $modules as $mod ) {
							if ($mod->position != $column) continue;
							     $HTML .= JSNHtml::openTag('div', array('class'=>"poweradmin-module-item", 'id'=>$mod->id.'-jsnposition-published', 'title'=>$mod->title, 'showtitle'=>$mod->showtitle))
