 ...
 * @version $Id: jsn_is_imagethumbnail.php 14273 2012-07-23 09:10:44Z giangnd $
...
//    		$thumbPath 		= $folderThumbnail.$thumbName;
	...
	function getImagesNeedCreateThumb($objImage)
    {
    	...
    	$thumbName		= str_replace('/', DS, $imagesTable->image_small);
    	$folderThumb	= JPATH_ROOT . DS . 'images' . DS . 'jsn_is_thumbs' . DS;
    	$thumbPath 		= JPATH_ROOT . DS . $thumbName;
