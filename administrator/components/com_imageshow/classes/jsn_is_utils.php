 ...
 * @version $Id: jsn_is_utils.php 14589 2012-07-30 03:32:32Z haonv $
...
//	}
	...
	function renderListItems($arrayItems, $type = "showlist")
	{
		...
		$html .= '<li class="primary"><a href="index.php?option=com_imageshow&controller='.$type.'&task=add" title="'.htmlspecialchars(${$type.'AddText'}).'"><span class="jsn-icon16 icon-plus"></span>'.${$type.'AddText'}.'</a></li>';
		$html .= '</ul>';
