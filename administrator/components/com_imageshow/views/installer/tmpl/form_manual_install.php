 ...
 * @version $Id: form_manual_install.php 14287 2012-07-23 11:14:16Z haonv $
...
?>
<div class="jsn-bootstrap jsn-manual-install-form">
	<form method="post" enctype="multipart/form-data" action="index.php?option=com_imageshow&controller=installer&task=installImagesourceManual">
		<h3 class="jsn-section-header"><?php echo JText::_('MANUAL_INSTALL_'.strtoupper($type))?></h3>
