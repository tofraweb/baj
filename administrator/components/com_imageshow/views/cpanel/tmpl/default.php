...
function enableButton()
{
	...
	if(showcaseID != 0)
	{
		$('edit-showcase').removeClass("disabled");
	...
	{
		$('edit-showcase').addClass("disabled");
	...
	if(showlistID != 0)
	{
		$('edit-showlist').removeClass("disabled");
	...
	{
		$('edit-showlist').addClass("disabled");
...
function choosePresentMethode()
{
	...
	if(methodValue == "module")
	{
		...
		$('jsn-go-link').setStyle('display', 'block');
		$('jsn-go-link').removeClass("disabled");
	}
	else if(methodValue == "plugin")
	{
		...
		$('jsn-go-link-modal').setStyle('display', 'block');
...
<![endif]-->
<div id="jsn-cpanel" class="jsn-cpanel-container">
	<div class="jsn-bootstrap">
		<div class="jsn-cpanel-block clearafter">
			<div class="jsn-process-step">1</div>
			<div class="jsn-gallery-option jsn-pane pane-default">
				<h3><?php echo JText::_('CPANEL_CPANEL_SHOWLIST'); ?></h3>
				...
				<div class="jsn-gallery-selection clearafter">
					...
					<span class="jsn-gallery-nav-button">
						<a href="javascript:void(0);" id="edit-showlist" target="" class="jsn-icon24 icon-pencil disabled" title="<?php echo htmlspecialchars(JText::_('CPANEL_YOU_MUST_SELECT_SOME_SHOWLIST_TO_EDIT')); ?>">&nbsp;</a>
						<a href="index.php?option=com_imageshow&controller=showlist&task=add" target="_blank" class="jsn-icon24 icon-plus" title="<?php echo htmlspecialchars(JText::_('CPANEL_CREATE_NEW_SHOWLIST')); ?>">&nbsp;</a>
						<a href="index.php?option=com_imageshow&controller=showlist" target="_blank" class="jsn-icon24 icon-folder" title="<?php echo htmlspecialchars(JText::_('CPANEL_SEE_ALL_SHOWLISTS')); ?>">&nbsp;</a>
					</span>
				</div>
			</div>
		</div>
		<div class="jsn-cpanel-block clearafter">
			<div class="jsn-process-step">2</div>
			<div class="jsn-gallery-option jsn-pane pane-default">
				<h3><?php echo JText::_('CPANEL_CPANEL_SHOWCASE'); ?></h3>
				<p><?php echo JText::_('CPANEL_SETUP_HOW_TO_PRESENT_IMAGES_IN_THE_GALLERY'); ?></p>
				<div class="jsn-gallery-selection clearafter">
					<?php echo $this->lists['showcase']; ?>
					<span class="jsn-gallery-nav-button">
						<a href="javascript:void(0);" id="edit-showcase" target="" class="jsn-icon24 icon-pencil disabled" title="<?php echo htmlspecialchars(JText::_('CPANEL_YOU_MUST_SELECT_SOME_SHOWCASE_TO_EDIT')); ?>">&nbsp;</a>
						<a href="index.php?option=com_imageshow&controller=showcase&task=add" target="_blank" class="jsn-icon24 icon-plus" title="<?php echo htmlspecialchars(JText::_('CPANEL_CREATE_NEW_SHOWCASE')); ?>">&nbsp;</a>
						<a href="index.php?option=com_imageshow&controller=showcase" target="_blank" class="jsn-icon24 icon-folder" title="<?php echo htmlspecialchars(JText::_('CPANEL_SEE_ALL_SHOWCASES')); ?>">&nbsp;</a>
					</span>
				</div>
			</div>
		</div>
		<div class="jsn-cpanel-block clearafter">
			<div class="jsn-process-step">3</div>
			<div class="jsn-gallery-option jsn-pane pane-info">
				<h3><?php echo JText::_('CPANEL_PRESENTATION'); ?></h3>
				<p><?php echo JText::_('CPANEL_CONFIGURE_HOW_TO_PRESENT_THE_GALLERY'); ?></p>
				<div class="jsn-gallery-selection clearafter">
					<a href="javascript:void(0);" class="btn disabled" title="<?php echo htmlspecialchars(JText::_('CPANEL_GO')); ?>" id="jsn-go-link"><?php echo JText::_('CPANEL_GO'); ?></a>
					<a rel='{"size": {"x": 500, "y": 350}}' class="btn disabled jsn-is-modal" id="jsn-go-link-modal" title="<?php echo htmlspecialchars(JText::_('CPANEL_GO')); ?>"><?php echo JText::_('CPANEL_GO'); ?></a>
