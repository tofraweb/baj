 ...
 * @version $Id: default_messages.php 13974 2012-07-13 09:35:02Z giangnd $
...
<div id="jsn-messages" class="jsn-page-list">
	<h2 class="jsn-section-header">
		<?php echo JText::_('MAINTENANCE_MESSAGES'); ?>
	</h2>
	<form action="index.php?option=com_imageshow&controller=maintenance&type=msgs" method="POST" name="adminForm" id="frm_msg" class="form-inline">
		<div class="jsn-fieldset-filter">
			<fieldset>
				<div class="pull-left jsn-fieldset-search">
					<a href="#" title="<?php echo htmlspecialchars(JText::_('MAINTENANCE_MSG_RETRIEVE_ALL_MESSAGES_FROM_LANGUAGE_FILE_AND_SET_SHOW_STAT	US_FOR_THEM')); ?>" onclick="refreshMsg();" class="btn"><i class="icon-refresh"></i> <?php echo JText::_('MAINTENANCE_MSG_REFRESH_ALL_MESSAGE'); ?></a>
				</div>
				<div class="pull-right jsn-fieldset-select">
					<?php echo $this->lists['arrayScreen']; ?>
				</div>
		...
		<table class="table table-bordered" border="0">
			...
			?>
				<tr class="<?php //echo "row$k"; ?>">
					...
					<td class="center"><?php echo JText::_($row->msg_screen); ?></td>
		...
		<div class="form-actions">
			<button class="btn btn-primary" type="button" onclick="saveMsg();" value="<?php echo JText::_('SAVE'); ?>"><?php echo JText::_('SAVE'); ?></button>
		</div>
	</form>
</div>
