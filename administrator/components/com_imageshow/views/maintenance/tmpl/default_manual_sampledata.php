 ...
 * @version $Id: default_manual_sampledata.php 14287 2012-07-23 11:14:16Z haonv $
		...
		<form action="index.php?option=com_imageshow&controller=maintenance&type=data" method="post" enctype="multipart/form-data">
			...
			<div class="jsn-manual-installation">
				<ul>
					...
					<li>2. <?php echo JText::_('MANUAL_SELECT_DOWNLOADED_PACKAGE');?>: <input id="sample_data_input_file" size="40" type="file" name="install_package" /></li>
				</ul>
			</div>
			<div id="jsn-start-installing-sampledata">
				<p>
					...
					<label for="agree_install_sample_local" style="display: inline-block;">
						<strong><?php echo JText::_('MAINTENANCE_SAMPLE_DATA_AGREE_INSTALL_SAMPLE_DATA'); ?></strong>
					</label>
				</p>
				<div class="form-actions">
					<button class="btn btn-primary agree_install_sample_local disabled" type="submit" name="button_installation_data" disabled="disabled"><?php echo JText::_('MAINTENANCE_SAMPLE_DATA_INSTALL_SAMPLE_DATA');?></button>
				</div>
			</div>
