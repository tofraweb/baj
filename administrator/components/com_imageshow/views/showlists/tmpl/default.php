...
?>
<div id="jsn-showlists" class="jsn-page-list">
	<div class="jsn-bootstrap">
		<form action="index.php?option=com_imageshow&controller=showlist" method="post" name="adminForm" id="adminForm" class="form-inline">
			<div class="jsn-fieldset-filter">
				<fieldset>
					<div class="pull-left jsn-fieldset-search">
						...
						<input type="text" class="input-xlarge" name="showlist_stitle" id="showlist_stitle" value="<?php echo $this->lists['showlistTitle'];?>" />
						<button class="btn" onclick="this.form.submit();"><?php echo JText::_('GO'); ?></button>
						<button class="btn" onclick="document.getElementById('showlist_stitle').value=''; document.adminForm.filter_access.value=''; document.adminForm.filter_state.value='';this.form.submit();"><?php echo JText::_('RESET'); ?></button>
					</div>
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th nowrap="nowrap" width="10%" class="jsn-order center">
					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td class="jsn-list-order center">
							<div class="input-prepend">
								...
								<input type="text" name="order[]" value="<?php echo $row->ordering; ?>" <?php echo $disabled ?> class="jsn-input-small-fluid" />
							</div>
						</td>
