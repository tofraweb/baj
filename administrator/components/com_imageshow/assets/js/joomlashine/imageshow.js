 ...
 * @version $Id: imageshow.js 14176 2012-07-19 08:58:46Z thangbh $
...
var JSNISImageShow = {
	...
	simpleSlide: function(clickID, slideID, arrowID, titleID, iconID, arrowAddClass, titleAddClass, iconClassExpand, iconClassCollapse)
	{
			...
			( 
				function()
				{
					if (slide.getStyle('margin') == '0px'){
						...
						$(iconID).className = iconClassCollapse;
					} else {
						$(iconID).className = iconClassExpand;
					}
				}
			);
