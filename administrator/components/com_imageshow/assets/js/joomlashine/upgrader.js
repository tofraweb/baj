...
var JSNISUpgrader =  new Class({
	...
	download: function()
	{
		...
		$('jsn-upgrader-successful-downloading').setStyle('display', 'none');
		$('jsn-upgrader-unsuccessful-downloading').setStyle('display', 'none');
		$('jsn-upgrader-upgraded').setStyle('display', 'none');
		$('jsn-upgrader-failure').setStyle('display', 'none');
	...
	installPackage: function(packagePath)
	{
		var jsonRequest = new Request.JSON({
			...
			onSuccess: function(jsonObj)
			{
				$('jsn-upgrader-data-package-installing-title').setStyle('display', 'none');
				if(jsonObj.success == true) {
					$('jsn-upgrader-upgraded').setStyle('display', 'list-item');
					$('jsn-installation-successfull-message').setStyle('display', 'block');
					$('jsn-installation-button-finish').setStyle('display', 'inline');
				}else{
					$('jsn-upgrader-failure').setStyle('display', 'list-item');
					$('jsn-installation-button-close').setStyle('display', 'inline');
				}
			}
		}).get({'option': 'com_imageshow',
				 'controller': 'installer',
				 'task': 'installImageShowCore',
