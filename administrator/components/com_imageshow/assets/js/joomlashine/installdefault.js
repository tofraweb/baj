...
var JSNISInstallDefault = {
		...
		if (this.currentEl) 
		{
			...
			if (this.currentEl.task == 'downloadShowcaseTheme') 
			{
				...
				if (status == 'failure') {
					...
					$('jsn-install-process-theme').getElements('.jsn-icon16').removeClass('icon-ok');
					$('jsn-install-process-theme').getElements('.jsn-icon16').addClass('icon-remove');
				}
			}
			...
			if (this.currentEl.task == 'downloadImageSource') 
			{
				...
				if (status == 'failure') {
					...
					$('jsn-install-process-source').getElements('.jsn-icon16').removeClass('icon-ok');
					$('jsn-install-process-source').getElements('.jsn-icon16').addClass('icon-remove');
				}
			}
		}
	},
	...
	restoreDataFailure: function()
	{
		...
		$('jsn-install-process-migrate').getElements('.jsn-icon16').removeClass('icon-ok');
		$('jsn-install-process-migrate').getElements('.jsn-icon16').addClass('icon-remove');
	},
