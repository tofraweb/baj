...
# @version $Id: default.php 13449 2012-06-22 04:13:33Z hiepnv $
-------------------------------------------------------------------------*/
...
if ( $this->jsnpwrender->isExternal() ){
	...
	$header = array();
	$header[] = JSNHtml::addCustomStyle(JSN_POWERADMIN_STYLE_URI, 'styles.css');
	$header[] = JSNHtml::addCustomStyle(JSN_POWERADMIN_STYLE_URI, 'visualmode_styles.css');
	$header[] = JSNHtml::addCustomStyle(JURI::root().'media/system/css/', 'modal.css');	
