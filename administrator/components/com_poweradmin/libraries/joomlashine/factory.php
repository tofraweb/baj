...
# @version $Id: factory.php 13785 2012-07-05 03:50:44Z hiepnv $
-------------------------------------------------------------------------*/
...
class JSNFactory
{
	...
	{
		JSNFactory::localimport('libraries.joomlashine.template.template');
		if (!isset(self::$template) ){
			self::$template = JSNTemplate::getInstance();
		}
	...
	public function _cURLCheckFunctions()
	{
