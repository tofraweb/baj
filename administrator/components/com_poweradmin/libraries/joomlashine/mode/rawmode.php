...
class JSNRawmode{
	...
	*/
	public function renderModulesPosition($position, $modules)
	{
		...
		$position_html  = JSNHtml::openTag('div', array('class'=>"jsn-element-container"));
		$position_html .= JSNHtml::openTag('div', array('class'=>"jsn-element-container_inner".$inactive_class));
		$position_html .= JSNHtml::openTag('div', array('class'=>"jsn-position-name"))
		                   .JSNHtml::openTag('h2')
		                      .$position
		                   .JSNHtml::closeTag('h2')
		               .JSNHtml::closeTag('div');

		$position_html .= JSNHtml::openTag('div', array('class'=>"clr")).JSNHtml::closeTag('div');		
		
		$position_html .= JSNHtml::openTag('div', array('class'=>'jsn-poweradmin-position', 'id'=>$position.'-jsnposition'));
		...
		for($i = 0; $i < $count; $i++){
			...
			$position_html .= JSNHtml::openTag('div', array('class'=>'poweradmin-module-item '.$class_unassignment.$class_publish, 'id'=>$module->id.'-jsnposition-'.$published, 'title'=>$module->moduletype));
			$position_html .= JSNHtml::openTag('div', array('class'=>"poweradmin-module-item-inner"));
			$position_html .= JSNHtml::openTag('div', array('class'=>"poweradmin-module-item-inner-text"));
			$position_html .= $module->title;
			$position_html .= JSNHtml::closeTag('div');
			$position_html .= JSNHtml::openTag('div', array('class'=>"clr")).JSNHtml::closeTag('div');
			$position_html .= JSNHtml::closeTag('div');
			$position_html .= JSNHtml::openTag('div', array('class'=>"poweradmin-module-item-drag-handle")).JSNHtml::closeTag('div');
			$position_html .= JSNHtml::openTag('div', array('class'=>"clr")).JSNHtml::closeTag('div');
			$position_html .= JSNHtml::closeTag('div');
		}
		$position_html .= JSNHtml::closeTag('div');
	...
	{
		$position_html  = JSNHtml::openTag('div', array('class'=>"jsn-element-container"));
		$position_html .= JSNHtml::openTag('div', array('class'=>"jsn-element-container_inner jsn-notdefault-element"));
		$position_html .= JSNHtml::openTag('div', array('class'=>"clr")).JSNHtml::closeTag('div');		
		$position_html .= JSNHtml::openTag('div', array('class'=>'jsn-poweradmin-position', 'id'=>'notdefault-jsnposition'));
