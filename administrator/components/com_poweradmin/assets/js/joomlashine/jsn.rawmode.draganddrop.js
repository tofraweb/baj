	...
	$.JSNDragandDrop = function( objs, JSNGrid ) 
	{
		...
		*/
		...
		this.save = function( dragElement, elementId, fromPos, toPos, orders ){
			...
			$.post
			(
				baseUrl + 'administrator/index.php?option=com_poweradmin&view=module&task=module.moveModule&lang='+lang, 
				{
					moduleid    : elementId, 
					oldposition : fromPos, 
					newposition : toPos, 
				...
				JSNGrid.buildModulesContentMenu(dragElement, false);
			}).error( function(msg){
				console.log(msg);
					...
					(
						{
							...
							keyPrefix  : true,
								...
								JSNGrid.buildModulesContentMenu(obj['goalElement'].find('div.poweradmin-module-item:last'), false);
							}
						}
					);
				});
