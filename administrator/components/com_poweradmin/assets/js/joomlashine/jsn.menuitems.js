	...
	$.fn.jstreeInstance = function(){
		...
		*/
		...
		$(document).unbind("showmenu.jstree").bind("showmenu.jstree", function(event, obj, items){	
			items['ccp']['submenu']['Makehome-Disabled'].show = false;
			items['ccp']['submenu']['Trash-Disabled'].show = false;
			items['ccp']['submenu']['Checkin-Disabled'].show =  false;
			items['Unpublish-Disabled'].show = false;
			...
			if ($(obj).hasClass('unpublish')){
				...
				toggleSubmenuItem (items['ccp']['submenu']['Makehome'], items['ccp']['submenu']['Makehome-Disabled'])
			}else if( $(obj).hasClass('default') ){
				toggleSubmenuItem (items['Unpublish'], items['Unpublish-Disabled'], true);
				toggleSubmenuItem (items['ccp']['submenu']['Makehome'], items['ccp']['submenu']['Makehome-Disabled']);
				toggleSubmenuItem (items['ccp']['submenu']['Trash'], items['ccp']['submenu']['Trash-Disabled'], true);
				...
				toggleSubmenuItem (items['ccp']['submenu']['Checkin'], items['ccp']['submenu']['Checkin-Disabled'], true);
				$(document).unbind("context_show.vakata").bind("context_show.vakata", function(){
					$._menuitems.jstreeContextMenuShowing = true;
				});
			}else{
				toggleSubmenuItem (items['ccp']['submenu']['Makehome'], items['ccp']['submenu']['Makehome-Disabled'], true);
				toggleSubmenuItem (items['ccp']['submenu']['Trash'], items['ccp']['submenu']['Trash-Disabled'], true);
				toggleSubmenuItem (items['ccp']['submenu']['Checkin'], items['ccp']['submenu']['Checkin-Disabled'], true);
