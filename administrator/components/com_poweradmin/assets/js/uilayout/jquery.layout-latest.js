...
,	options = {
	...
	,	resizeWithWindowDelay:		0			// delay calling resizeAll because makes window resizing very jerky
...
,	_parseSize = function (pane, size, dir) {
		...
		$(window).triggerHandler("windowResizeComplete");
	}
...
,	windowResize = function () {
	    //jsn backup all command in this function 
...
,	initResizable = function (panes) {
		...
		$.each(panes.split(","), function (idx, pane) {
			...
			,	drag: function (e, ui) {
					...
					//JSN Added
					$R.trigger("jsn_dragging_resize", [$R]);
